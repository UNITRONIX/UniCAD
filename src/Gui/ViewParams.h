...
#define FC_VIEW_PARAMS \
    ...
    FC_VIEW_PARAM(DefaultShapeLineColor, unsigned long, Unsigned, 589505280UL) \
    FC_VIEW_PARAM(DefaultShapeVertexColor, unsigned long, Unsigned, 589505280UL) \
    FC_VIEW_PARAM(DefaultShapeColor, unsigned long, Unsigned, 0xB6B8BC00) \
