...
4. **UI jest lokalne względem kursora i obiektu**  
   Sketch Palette, manipulator, menu radialne, toolbox pod klawiszem `S` – wszystko to skraca drogę kursora i liczbę przełączeń uwagi. [A4] [A6] [A7]
...
8. **Fusion rozdziela strukturę od czasu**  
   Browser pokazuje hierarchię modelu, a Timeline – historię jego powstawania. To fundamentalnie poprawia czytelność.
...
## 17. Nawigacja – dlaczego Fusion nie męczy

### 17.1. Nie chodzi tylko o skróty myszy

Fusion zmniejsza zmęczenie nawigacyjne dzięki kombinacji:
- spójnego PZO (pan/zoom/orbit),
- zorientowanego widgetu widoku,
- szybkiego dostępu z menu pod prawym przyciskiem,
- dobrze dobranego punktu obrotu,
- przystępnych presetów nawigacyjnych dla użytkowników przychodzących z innych programów. [A4]

### 17.2. Co ma FreeCAD

FreeCAD już dziś wspiera wiele stylów nawigacji, wybieranych ze status bara lub preferencji. [F4]

To znaczy, że najlepszą drogą nie jest rewolucja, tylko **dodanie stylu „Fusion-like”** oraz poprawa elementów pomocniczych.

### 17.3. Co powinno wejść do moda

- preset nawigacji zgodny mięśniowo z Fusion,
- zoom do kursora,
- recenter/orbit around pick,
- wyraźny wskaźnik środka obrotu,
- prosty widget orientacji widoku,
- szybkie `Fit`, `Look At`, przekroje i izolacja dostępne z tego samego miejsca.

### 17.4. Dlaczego to ważne dla adopcji

Ludzie bardzo często oceniają „łatwość CAD-a” po 15 minutach.  
Jeżeli w te 15 minut:
- walczą z orbitą,
- gubią punkt obrotu,
- nie mogą wrócić do płaszczyzny szkicu,
to uznają program za trudny **zanim dotkną właściwego modelowania**.
...
Klawisz `S` otwiera toolbox / wyszukiwarkę narzędzi aktualnego workspace’u. [A4]
...
Dokumentacja FreeCAD w linkach [F2]-[F4] pochodzi z publicznego HTML mirror wiki FreeCAD.  
